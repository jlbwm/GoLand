...
const (
	...
	ES_URL      = "http://35.224.250.82:9200"
	BUCKET_NAME = "post-images-2499054426"
)
...
// Example URL: http://localhost:8080/search?lat=37.5&lon=-120&range=10
...
func containsFilteredWords(s *string) bool {
	filteredWords := []string{"fuck", "nigger"}
